...
namespace Constants {
    constexpr float DEFAULT_METERS_PER_CELL = 0.1f;  ///< Default size of each grid cell in meters
    constexpr float DEFAULT_PIXELS_PER_METER = 50.0f; ///< Default scale factor to convert meters to pixels
    constexpr int MAP_SIZE_CELLS = 500;                   ///< Default number of cells per side in the square grid map
